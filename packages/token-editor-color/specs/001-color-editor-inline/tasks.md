...
- [ ] T011 Rewrite `packages/token-editor-color/src/components/ColorEditor/ColorEditor.tsx` shell — branch object-form vs legacy bare-hex (research R9):
