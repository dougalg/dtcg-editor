import { TOKEN_TYPE_ICON_SPRITE_MARKUP } from "../../lib/tokens/token-type-icon-sprite.ts";

/**
 * Injects the token-type icon sprite (see `token-type-icon-sprite.ts`) into
...
export function TokenTypeIconSprite() {
	return (
		<div
			// biome-ignore lint/security/noDangerouslySetInnerHtml: sprite markup is assembled at build time from this repo's own vendored .svg files (see lib/tokens/icons/), never from user/runtime input.
