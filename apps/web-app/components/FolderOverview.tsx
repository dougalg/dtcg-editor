...
export function FolderOverview({ files }: { files: readonly TokenFileSummary[] }) {
  if (files.length === 0) {
    return <p className={styles.empty}>No .json files found in the configured token directory.</p>;
  }
