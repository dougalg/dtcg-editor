...
- [X] T048 [P] Run quickstart.md's Section 4 manual editor smoke check (`pnpm --filter web-app dev`; edit a color and a dimension token) as a human sanity check on top of T046's automated suite — confirmed manually by the user
