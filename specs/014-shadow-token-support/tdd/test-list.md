...
| A9  | Editing one sub-value of the second of two layers changes only that field of that layer      | US2-AS4       | example | PENDING |                                                                                             |
...
| U28 | "Move down"/"Move up" reorders layers without altering any layer's own sub-values                      | FR-004, FR-005 | example | PENDING |     |
