...
| A7  | A1–A6 all hold on the 2,000-token fixture, not only at 1,000 | SC-007, FR-015 | example | DONE | `apps/web-app/e2e/editing-perf.spec.ts::the SC-001..SC-006 guards run at the 2,000-token ceiling (A7)` (cycle 92; every A1/A2/A4/A5/A6 test navigates `large_scale.tokens.json` (2,005 rows); A7 pins it ≥2,000; T047 re-measure in cycles 85–87 missed no budget -> no virtualization decision) |
