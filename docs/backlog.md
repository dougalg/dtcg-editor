...
- [ ] Prettier should be run in a pre-commit step to ensure formatting is applied. Possibly with lint-staged or similar to make it simple. (in progress — worktree `.claude/worktrees/prettier-pre-commit`, branch `worktree-prettier-pre-commit`)
