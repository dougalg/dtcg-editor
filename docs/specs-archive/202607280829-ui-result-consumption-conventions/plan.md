...
- [x] Create `apps/web-app/hooks/useSaveTokenEdits.ts`:
  ...
  export function useSaveTokenEdits(
  	...
  	const [saveError, setSaveError] = useState<SaveError | undefined>(
  		undefined,
  	);
